...
void mpu_get_data(void)
{
	...
	{
		rt_kprintf("mpu9250 data temp:%d pitch:%f roll:%f yaw:%f \r\n",MPU_Get_Temperature(),pitch,roll,yaw);
	}
	else
	{
		rt_kprintf("get mpu9250 data fail \r\n");
	}
}

MSH_CMD_EXPORT(mpu_get_data, get mpu9250 data);
